...
% A machine-readable row for pin-to-pin wiring tables. The first argument is
% a stable connection name used by the diagram generator; the remaining
% arguments are printed as the table's three visible columns.
\newcommand{\connectionrow}[4]{#2 & #3 & #4 \\}

\begin{document}

% Include the title page PDF if it exists; skip gracefully during CI when not yet present
\IfFileExists{title_page.pdf}{\includepdf{title_page.pdf}}{}
...
\input{projects/project_1.tex}
\input{projects/project_2.tex}
\input{projects/project_3.tex}
\input{projects/project_4.tex}
\input{projects/project_5.tex}
\input{projects/project_6.tex}
\input{projects/project_7.tex}
