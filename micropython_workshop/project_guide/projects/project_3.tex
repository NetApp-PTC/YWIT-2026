...
\begin{tabular}{|l|l|l|}
    ...
    \hline
    \connectionrow{pixels.data}{DI (first LED)}{GPIO 20}{D7}
    \connectionrow{pixels.power}{5V (power in)}{3V3}{3V3}
    \connectionrow{pixels.ground}{GND}{GND}{GND}
    \hline
\end{tabular}
\end{center}
...
\textbf{GND} into \bbhole{pixels.header.ground}{J14}. Then run three jumper wires:
\begin{itemize}
    \item \bbhole{jumper.pixels-power.start}{I3} to \bbhole{jumper.pixels-power.end}{I12}, which
    feeds 3.3 volts to the pin marked 5V
    \item \bbhole{jumper.pixels-data.start}{I7} to \bbhole{jumper.pixels-data.end}{I13}, which
    connects \textbf{GPIO 20} to \textbf{DI}
    \item \bbhole{jumper.pixels-ground.start}{I2} to \bbhole{jumper.pixels-ground.end}{I14}
\end{itemize}
...
\begin{tabular}{|l|l|l|}
    ...
    \hline
    \connectionrow{button.signal}{One side}{GPIO 21}{D6}
    \connectionrow{button.ground}{Other side}{GND}{GND}
    \hline
\end{tabular}
\end{center}
...
button closes. Then run two more jumper wires:
\begin{itemize}
    \item \bbhole{jumper.button-signal.start}{C7} to \bbhole{jumper.button-signal.end}{E12}, which
    connects \textbf{GPIO 21} to one pair of legs
    \item \bbhole{jumper.button-ground.start}{J2} to \bbhole{jumper.button-ground.end}{E14}, which
    grounds the other pair
\end{itemize}
...
\begin{figure}[H]
    \centering
    \maybeincludegraphics[width=.9\linewidth]{project_3/wiring.png}
