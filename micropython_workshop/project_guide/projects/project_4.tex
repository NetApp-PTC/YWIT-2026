...
\begin{itemize}
    ...
    \item 3x WS2812B addressable RGB LEDs (strip segment with right-angle header)
...
The 3-pixel WS2812B strip has a 3-pin right-angle header at its \textbf{DI} (Data In) end.
Insert the strip into row \textbf{F} (rows 22--24) on the right side of the breadboard so it is
...
\begin{tabular}{|l|l|l|}
    ...
    \hline
    \connectionrow{pixels-power}{5V (power)}{3V3}{I3}{J22}
    \connectionrow{pixels-data}{DI (data in)}{GPIO 20}{I7}{J23}
