...
\begin{tabular}{|l|l|l|}
    ...
    \hline
    \connectionrow{pixels-power}{5V}{3V3}{I3}{I12}
...
\begin{figure}[H]
    \centering
    \maybeincludegraphics[width=.95\linewidth]{project_2/wiring.png}
...
\begin{enumerate}
    \item Confirm LED order on your strip: the LED closest to the header is red, the middle is yellow, and the far end is green.
