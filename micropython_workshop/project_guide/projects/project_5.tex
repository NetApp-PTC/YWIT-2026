...
\begin{tabular}{|l|l|l|}
    ...
    \hline
    \connectionrow{pixels.data}{DI (data in)}{GPIO 20 (D7)}{Data input for first LED}
    \connectionrow{pixels.power}{5V}{5V (or 3V3)}{5V is preferred for brightness consistency}
    \connectionrow{pixels.ground}{GND}{GND}{Must share ground with microcontroller}
    \hline
\end{tabular}
\end{center}
...
\begin{itemize}
    \item \bbhole{jumper.pixels-power.start}{I1} to \bbhole{jumper.pixels-power.end}{I12}
