...
by going to \url{https://viper-ide.blackhart.dev/}. Click on the USB icon in the top right and choose your
microcontroller from the list:

\begin{figure}[H]
    \centering
    \maybeincludegraphics[width=.8\linewidth]{common/viper_ide_usb_connect.png}
...
\begin{figure}[H]
    \centering
    \maybeincludegraphics[width=.6\linewidth]{common/viper_ide_usb_choice_connect.png}
    \caption{Click the button highlighted in red.}
\end{figure}
